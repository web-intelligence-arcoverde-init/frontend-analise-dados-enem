    ...
    return (
        <div className={styles.chooseAnSkill}>
            <div className={styles.topContainer}>
                <h2 className={styles.title}><RiStackFill />Escolha uma competência</h2>
            ...
            <div className={styles.bottomContainer}>
                <div className={styles.textBox}>
                    ...
                    veniam nam, pariatur Nesciunt commodi assumenda rerum, blanditiis velit
                    impedit accusamus voluptatum natus quod odit. Natus
                    veniam nam, pariatur
                </div>
